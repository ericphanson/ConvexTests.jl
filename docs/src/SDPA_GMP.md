...
Compilation warmup gives an estimate of 29 seconds of compilation time.
...
```julia
 ──────────────────────────────────────────────────────────────────────────────
                                       Time                   Allocations      
                               ──────────────────────   ───────────────────────
       Tot / % measured:             135s / 100%            28.6GiB / 100%     

 Section               ncalls     time   %tot     avg     alloc   %tot      avg
 ──────────────────────────────────────────────────────────────────────────────
 socp                       1    56.5s  41.9%   56.5s   12.4GiB  43.3%  12.4GiB
   socp_dual_froben...      1    24.7s  18.3%   24.7s    166MiB  0.57%   166MiB
   socp_rational_no...      1    9.59s  7.11%   9.59s   9.72GiB  34.0%  9.72GiB
   socp_dual_minima...      1    5.83s  4.32%   5.83s    492MiB  1.68%   492MiB
   socp_quad_form_atom      1    2.61s  1.93%   2.61s   38.6MiB  0.13%  38.6MiB
   socp_sum_squares...      1    1.17s  0.87%   1.17s    116MiB  0.40%   116MiB
   socp_inv_pos_atom        1    1.14s  0.85%   1.14s    101MiB  0.35%   101MiB
   socp_rational_no...      1    987ms  0.73%   987ms    150MiB  0.51%   150MiB
   socp_dual_norm_2...      1    850ms  0.63%   850ms   74.7MiB  0.26%  74.7MiB
   socp_fix_multipl...      1    739ms  0.55%   739ms   43.2MiB  0.15%  43.2MiB
   socp_quad_over_l...      1    664ms  0.49%   664ms   34.1MiB  0.12%  34.1MiB
   socp_rational_no...      1    649ms  0.48%   649ms    225MiB  0.77%   225MiB
   socp_huber_atom          1    580ms  0.43%   580ms   65.3MiB  0.22%  65.3MiB
   socp_square_atom         1    558ms  0.41%   558ms   34.5MiB  0.12%  34.5MiB
   socp_norm_consis...      1    517ms  0.38%   517ms   35.9MiB  0.12%  35.9MiB
   socp_geo_mean_atom       1    382ms  0.28%   382ms   30.0MiB  0.10%  30.0MiB
   socp_fix_and_fre...      1    352ms  0.26%   352ms   32.6MiB  0.11%  32.6MiB
   socp_sqrt_atom           1   45.5ms  0.03%  45.5ms   1.10MiB  0.00%  1.10MiB
 affine                     1    26.4s  19.6%   26.4s   3.11GiB  10.9%  3.11GiB
   affine_permutedd...      1    2.56s  1.90%   2.56s    338MiB  1.15%   338MiB
   affine_dot_multi...      1    2.47s  1.83%   2.47s    216MiB  0.74%   216MiB
   affine_hcat_atom         1    2.39s  1.77%   2.39s    355MiB  1.21%   355MiB
   affine_multiply_...      1    2.13s  1.58%   2.13s    233MiB  0.80%   233MiB
   affine_transpose...      1    1.91s  1.41%   1.91s    151MiB  0.52%   151MiB
   affine_vcat_atom         1    1.55s  1.15%   1.55s    224MiB  0.77%   224MiB
   affine_index_atom        1    1.16s  0.86%   1.16s    176MiB  0.60%   176MiB
   affine_Diagonal_...      1    1.14s  0.84%   1.14s    116MiB  0.40%   116MiB
   affine_satisfy_p...      1    1.05s  0.78%   1.05s   61.8MiB  0.21%  61.8MiB
   affine_add_atom          1    1.01s  0.75%   1.01s   69.5MiB  0.24%  69.5MiB
   affine_conv_atom         1    844ms  0.63%   844ms   57.3MiB  0.20%  57.3MiB
   affine_sum_atom          1    599ms  0.44%   599ms   58.6MiB  0.20%  58.6MiB
   affine_reshape_atom      1    577ms  0.43%   577ms   43.9MiB  0.15%  43.9MiB
   affine_dot_atom          1    558ms  0.41%   558ms   27.6MiB  0.09%  27.6MiB
   affine_dualvalue         1    488ms  0.36%   488ms   38.5MiB  0.13%  38.5MiB
   affine_kron_atom         1    278ms  0.21%   278ms   20.0MiB  0.07%  20.0MiB
   affine_dot_atom_...      1    195ms  0.14%   195ms   17.3MiB  0.06%  17.3MiB
   affine_diag_atom         1    186ms  0.14%   186ms   23.5MiB  0.08%  23.5MiB
   affine_negate_atom       1   98.1ms  0.07%  98.1ms   4.45MiB  0.02%  4.45MiB
   affine_trace_atom        1   58.4ms  0.04%  58.4ms   3.65MiB  0.01%  3.65MiB
 sdp                        1    23.7s  17.6%   23.7s   2.44GiB  8.55%  2.44GiB
   sdp_Partial_trace        1    3.07s  2.27%   3.07s    307MiB  1.05%   307MiB
   sdp_operator_nor...      1    3.05s  2.26%   3.05s    269MiB  0.92%   269MiB
   sdp_lambda_min_atom      1    2.56s  1.90%   2.56s    243MiB  0.83%   243MiB
   sdp_matrix_frac_...      1    1.67s  1.24%   1.67s    142MiB  0.49%   142MiB
   sdp_Complex_Vari...      1    1.65s  1.22%   1.65s    295MiB  1.01%   295MiB
   sdp_sum_largest_...      1    1.56s  1.16%   1.56s    148MiB  0.50%   148MiB
   sdp_nuclear_norm...      1    1.43s  1.06%   1.43s    143MiB  0.49%   143MiB
   sdp_matrix_frac_...      1    1.29s  0.95%   1.29s    103MiB  0.35%   103MiB
   sdp_dual_lambda_...      1    932ms  0.69%   932ms   86.1MiB  0.29%  86.1MiB
   sdp_socp_sumsqua...      1    718ms  0.53%   718ms   64.4MiB  0.22%  64.4MiB
   sdp_Issue_198            1    626ms  0.46%   626ms   51.9MiB  0.18%  51.9MiB
   sdp_Real_Variabl...      1    453ms  0.34%   453ms   48.3MiB  0.17%  48.3MiB
   sdp_sdp_variables        1    415ms  0.31%   415ms   33.5MiB  0.11%  33.5MiB
   sdp_socp_norm2_atom      1    359ms  0.27%   359ms   25.9MiB  0.09%  25.9MiB
   sdp_sigma_max_atom       1    276ms  0.20%   276ms   19.3MiB  0.07%  19.3MiB
   sdp_socp_abs_atom        1    248ms  0.18%   248ms   18.7MiB  0.06%  18.7MiB
   sdp_kron_atom            1    237ms  0.18%   237ms   27.4MiB  0.09%  27.4MiB
   sdp_sdp_constraints      1    174ms  0.13%   174ms   13.9MiB  0.05%  13.9MiB
 lp                         1    16.0s  11.9%   16.0s   9.38GiB  32.9%  9.38GiB
   lp_minimum_atom          1    8.30s  6.15%   8.30s   6.46GiB  22.6%  6.46GiB
   lp_sumsmallest_atom      1    2.29s  1.70%   2.29s   1.80GiB  6.31%  1.80GiB
   lp_sumlargest_atom       1    1.27s  0.94%   1.27s    583MiB  1.99%   583MiB
   lp_dotsort_atom          1    1.17s  0.87%   1.17s    187MiB  0.64%   187MiB
   lp_neg_atom              1    418ms  0.31%   418ms   32.8MiB  0.11%  32.8MiB
   lp_dual_abs_atom         1    363ms  0.27%   363ms   33.1MiB  0.11%  33.1MiB
   lp_maximum_atom          1    296ms  0.22%   296ms   47.4MiB  0.16%  47.4MiB
   lp_dual_norm_inf...      1    152ms  0.11%   152ms   9.79MiB  0.03%  9.79MiB
   lp_pos_atom              1    131ms  0.10%   131ms   9.79MiB  0.03%  9.79MiB
   lp_dual_norm_1_atom      1   98.9ms  0.07%  98.9ms   7.09MiB  0.02%  7.09MiB
   lp_hinge_loss_atom       1    309μs  0.00%   309μs   49.7KiB  0.00%  49.7KiB
 constant                   1    12.3s  9.10%   12.3s   1.25GiB  4.36%  1.25GiB
   constant_fix!_wi...      1    4.14s  3.07%   4.14s    408MiB  1.40%   408MiB
   constant_Issue_166       1    3.13s  2.32%   3.13s    350MiB  1.20%   350MiB
   constant_fix!_wi...      1    2.08s  1.54%   2.08s    166MiB  0.57%   166MiB
   constant_Issue_228       1    833ms  0.62%   833ms   68.2MiB  0.23%  68.2MiB
   constant_Test_do...      1    489ms  0.36%   489ms   28.7MiB  0.10%  28.7MiB
   constant_fix!_an...      1    337ms  0.25%   337ms   32.0MiB  0.11%  32.0MiB
 ──────────────────────────────────────────────────────────────────────────────
```

## SDPA_GMP presolve=false
These tests were run on March 4, 2020 at 18:05 (UTC).
...
```julia
 ──────────────────────────────────────────────────────────────────────────────
                                       Time                   Allocations      
                               ──────────────────────   ───────────────────────
       Tot / % measured:            73.6s / 98.7%           6.72GiB / 98.9%    

 Section               ncalls     time   %tot     avg     alloc   %tot      avg
 ──────────────────────────────────────────────────────────────────────────────
 socp                       1    34.1s  46.9%   34.1s    819MiB  12.0%   819MiB
   socp_dual_froben...      1    24.3s  33.4%   24.3s   25.0MiB  0.37%  25.0MiB
   socp_dual_minima...      1    3.54s  4.87%   3.54s    310MiB  4.55%   310MiB
   socp_rational_no...      1    1.22s  1.67%   1.22s   45.4MiB  0.67%  45.4MiB
   socp_dual_norm_2...      1    670ms  0.92%   670ms   56.6MiB  0.83%  56.6MiB
   socp_fix_multipl...      1    498ms  0.69%   498ms   34.7MiB  0.51%  34.7MiB
   socp_inv_pos_atom        1    412ms  0.57%   412ms   15.4MiB  0.23%  15.4MiB
   socp_rational_no...      1    393ms  0.54%   393ms   11.6MiB  0.17%  11.6MiB
   socp_square_atom         1    320ms  0.44%   320ms   17.4MiB  0.25%  17.4MiB
   socp_rational_no...      1    277ms  0.38%   277ms   12.8MiB  0.19%  12.8MiB
   socp_quad_form_atom      1    231ms  0.32%   231ms   13.1MiB  0.19%  13.1MiB
   socp_quad_over_l...      1    169ms  0.23%   169ms   9.00MiB  0.13%  9.00MiB
   socp_huber_atom          1    153ms  0.21%   153ms   14.1MiB  0.21%  14.1MiB
   socp_sum_squares...      1    153ms  0.21%   153ms   8.77MiB  0.13%  8.77MiB
   socp_geo_mean_atom       1    135ms  0.19%   135ms   5.57MiB  0.08%  5.57MiB
   socp_fix_and_fre...      1   80.3ms  0.11%  80.3ms   4.43MiB  0.07%  4.43MiB
   socp_norm_consis...      1    439μs  0.00%   439μs   58.9KiB  0.00%  58.9KiB
   socp_sqrt_atom           1   87.1μs  0.00%  87.1μs   22.2KiB  0.00%  22.2KiB
 affine                     1    17.1s  23.6%   17.1s   4.66GiB  70.1%  4.66GiB
   affine_Partial_t...      1    10.6s  14.7%   10.6s   4.14GiB  62.2%  4.14GiB
   affine_transpose...      1    577ms  0.79%   577ms   22.9MiB  0.34%  22.9MiB
   affine_dot_multi...      1    478ms  0.66%   478ms   31.3MiB  0.46%  31.3MiB
   affine_multiply_...      1    386ms  0.53%   386ms   28.2MiB  0.41%  28.2MiB
   affine_hcat_atom         1    382ms  0.53%   382ms   9.50MiB  0.14%  9.50MiB
   affine_index_atom        1    381ms  0.52%   381ms   29.3MiB  0.43%  29.3MiB
   affine_reshape_atom      1    365ms  0.50%   365ms   18.4MiB  0.27%  18.4MiB
   affine_vcat_atom         1    323ms  0.44%   323ms   12.1MiB  0.18%  12.1MiB
   affine_sum_atom          1    284ms  0.39%   284ms   23.1MiB  0.34%  23.1MiB
   affine_Diagonal_...      1    213ms  0.29%   213ms   20.5MiB  0.30%  20.5MiB
   affine_dualvalue         1    172ms  0.24%   172ms   13.2MiB  0.19%  13.2MiB
   affine_add_atom          1    168ms  0.23%   168ms   10.3MiB  0.15%  10.3MiB
   affine_diag_atom         1    162ms  0.22%   162ms   16.1MiB  0.24%  16.1MiB
   affine_conv_atom         1    149ms  0.21%   149ms   9.84MiB  0.14%  9.84MiB
   affine_satisfy_p...      1    112ms  0.15%   112ms   6.44MiB  0.09%  6.44MiB
   affine_dot_atom          1   76.0ms  0.10%  76.0ms   6.55MiB  0.10%  6.55MiB
   affine_dot_atom_...      1   59.0ms  0.08%  59.0ms   3.68MiB  0.05%  3.68MiB
   affine_trace_atom        1   56.1ms  0.08%  56.1ms   3.35MiB  0.05%  3.35MiB
   affine_negate_atom       1   54.9ms  0.08%  54.9ms   2.93MiB  0.04%  2.93MiB
   affine_permutedd...      1   5.45ms  0.01%  5.45ms    172KiB  0.00%   172KiB
   affine_kron_atom         1    247μs  0.00%   247μs   30.2KiB  0.00%  30.2KiB
 lp                         1    13.8s  19.0%   13.8s    538MiB  7.89%   538MiB
   lp_min_atom              1    3.49s  4.80%   3.49s   98.5MiB  1.45%  98.5MiB
   lp_max_atom              1    3.43s  4.73%   3.43s   94.6MiB  1.39%  94.6MiB
   lp_minimum_atom          1    3.41s  4.70%   3.41s   29.2MiB  0.43%  29.2MiB
   lp_sumsmallest_atom      1    687ms  0.95%   687ms   26.4MiB  0.39%  26.4MiB
   lp_sumlargest_atom       1    535ms  0.74%   535ms   36.2MiB  0.53%  36.2MiB
   lp_dotsort_atom          1    361ms  0.50%   361ms   24.1MiB  0.35%  24.1MiB
   lp_dual_abs_atom         1    233ms  0.32%   233ms   18.2MiB  0.27%  18.2MiB
   lp_maximum_atom          1    129ms  0.18%   129ms   13.4MiB  0.20%  13.4MiB
   lp_pos_atom              1    103ms  0.14%   103ms   7.30MiB  0.11%  7.30MiB
   lp_dual_norm_inf...      1    101ms  0.14%   101ms   4.70MiB  0.07%  4.70MiB
   lp_dual_norm_1_atom      1   96.6ms  0.13%  96.6ms   4.60MiB  0.07%  4.60MiB
   lp_neg_atom              1   77.4ms  0.11%  77.4ms   5.21MiB  0.08%  5.21MiB
   lp_hinge_loss_atom       1   71.3μs  0.00%  71.3μs   21.4KiB  0.00%  21.4KiB
 sdp                        1    5.95s  8.19%   5.95s    527MiB  7.73%   527MiB
   sdp_matrix_frac_...      1    813ms  1.12%   813ms   61.1MiB  0.90%  61.1MiB
   sdp_Complex_Vari...      1    601ms  0.83%   601ms   16.5MiB  0.24%  16.5MiB
   sdp_Real_Variabl...      1    372ms  0.51%   372ms   9.24MiB  0.14%  9.24MiB
   sdp_sum_largest_...      1    360ms  0.50%   360ms   31.7MiB  0.46%  31.7MiB
   sdp_sdp_variables        1    350ms  0.48%   350ms   27.4MiB  0.40%  27.4MiB
   sdp_Partial_trace        1    311ms  0.43%   311ms   29.6MiB  0.43%  29.6MiB
   sdp_Issue_198            1    230ms  0.32%   230ms   20.3MiB  0.30%  20.3MiB
   sdp_dual_lambda_...      1    226ms  0.31%   226ms   27.8MiB  0.41%  27.8MiB
   sdp_socp_sumsqua...      1    223ms  0.31%   223ms   10.4MiB  0.15%  10.4MiB
   sdp_nuclear_norm...      1    172ms  0.24%   172ms   20.6MiB  0.30%  20.6MiB
   sdp_matrix_frac_...      1    139ms  0.19%   139ms   10.4MiB  0.15%  10.4MiB
   sdp_sigma_max_atom       1    116ms  0.16%   116ms   15.2MiB  0.22%  15.2MiB
   sdp_operator_nor...      1    109ms  0.15%   109ms   14.9MiB  0.22%  14.9MiB
   sdp_sdp_constraints      1    102ms  0.14%   102ms   9.75MiB  0.14%  9.75MiB
   sdp_kron_atom            1   94.4ms  0.13%  94.4ms   7.17MiB  0.11%  7.17MiB
   sdp_socp_abs_atom        1   88.8ms  0.12%  88.8ms   5.17MiB  0.08%  5.17MiB
   sdp_socp_norm2_atom      1   79.7ms  0.11%  79.7ms   4.73MiB  0.07%  4.73MiB
   sdp_lambda_min_atom      1   62.3ms  0.09%  62.3ms   5.04MiB  0.07%  5.04MiB
 constant                   1    1.69s  2.32%   1.69s    156MiB  2.28%   156MiB
   constant_Issue_166       1    553ms  0.76%   553ms   68.1MiB  1.00%  68.1MiB
   constant_fix!_wi...      1    201ms  0.28%   201ms   10.8MiB  0.16%  10.8MiB
   constant_fix!_wi...      1    166ms  0.23%   166ms   10.0MiB  0.15%  10.0MiB
   constant_Test_do...      1    142ms  0.20%   142ms   5.97MiB  0.09%  5.97MiB
   constant_Issue_228       1    114ms  0.16%   114ms   9.91MiB  0.15%  9.91MiB
   constant_fix!_an...      1   64.4ms  0.09%  64.4ms   3.76MiB  0.06%  3.76MiB
 ──────────────────────────────────────────────────────────────────────────────
```
