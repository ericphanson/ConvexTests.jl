...
Compilation warmup gives an estimate of 30 seconds, 547 milliseconds of compilation time.
...
Tests took 2 minutes, 23 seconds, 633 milliseconds to run (after warmup).
...
```julia
 ...
 ──────────────────────────────────────────────────────────────────────────────
 socp                       1    59.8s  41.8%   59.8s   12.4GiB  43.3%  12.4GiB
   socp_dual_froben...      1    26.0s  18.2%   26.0s    166MiB  0.57%   166MiB
   socp_rational_no...      1    10.0s  7.00%   10.0s   9.72GiB  34.0%  9.72GiB
   socp_dual_minima...      1    6.24s  4.36%   6.24s    493MiB  1.69%   493MiB
   socp_quad_form_atom      1    2.71s  1.89%   2.71s   38.5MiB  0.13%  38.5MiB
   socp_sum_squares...      1    1.29s  0.90%   1.29s    116MiB  0.40%   116MiB
   socp_inv_pos_atom        1    1.20s  0.84%   1.20s    101MiB  0.34%   101MiB
   socp_rational_no...      1    1.06s  0.74%   1.06s    149MiB  0.51%   149MiB
   socp_dual_norm_2...      1    936ms  0.65%   936ms   74.6MiB  0.26%  74.6MiB
   socp_fix_multipl...      1    855ms  0.60%   855ms   43.2MiB  0.15%  43.2MiB
   socp_quad_over_l...      1    743ms  0.52%   743ms   34.1MiB  0.12%  34.1MiB
   socp_rational_no...      1    702ms  0.49%   702ms    225MiB  0.77%   225MiB
   socp_square_atom         1    612ms  0.43%   612ms   34.4MiB  0.12%  34.4MiB
   socp_norm_consis...      1    566ms  0.40%   566ms   35.9MiB  0.12%  35.9MiB
   socp_huber_atom          1    543ms  0.38%   543ms   65.3MiB  0.22%  65.3MiB
   socp_geo_mean_atom       1    427ms  0.30%   427ms   30.0MiB  0.10%  30.0MiB
   socp_fix_and_fre...      1    339ms  0.24%   339ms   32.6MiB  0.11%  32.6MiB
   socp_sqrt_atom           1   50.0ms  0.03%  50.0ms   1.10MiB  0.00%  1.10MiB
 affine                     1    28.1s  19.6%   28.1s   3.11GiB  10.9%  3.11GiB
   affine_permutedd...      1    2.84s  1.99%   2.84s    339MiB  1.16%   339MiB
   affine_dot_multi...      1    2.62s  1.83%   2.62s    216MiB  0.74%   216MiB
   affine_hcat_atom         1    2.50s  1.75%   2.50s    355MiB  1.21%   355MiB
   affine_multiply_...      1    2.27s  1.59%   2.27s    233MiB  0.80%   233MiB
   affine_transpose...      1    2.06s  1.44%   2.06s    151MiB  0.52%   151MiB
   affine_vcat_atom         1    1.59s  1.11%   1.59s    224MiB  0.77%   224MiB
   affine_Diagonal_...      1    1.25s  0.88%   1.25s    116MiB  0.40%   116MiB
   affine_index_atom        1    1.20s  0.84%   1.20s    176MiB  0.60%   176MiB
   affine_satisfy_p...      1    1.12s  0.79%   1.12s   61.8MiB  0.21%  61.8MiB
   affine_add_atom          1    1.09s  0.76%   1.09s   69.5MiB  0.24%  69.5MiB
   affine_conv_atom         1    878ms  0.61%   878ms   57.3MiB  0.20%  57.3MiB
   affine_reshape_atom      1    654ms  0.46%   654ms   43.9MiB  0.15%  43.9MiB
   affine_sum_atom          1    583ms  0.41%   583ms   58.9MiB  0.20%  58.9MiB
   affine_dot_atom          1    568ms  0.40%   568ms   27.5MiB  0.09%  27.5MiB
   affine_dualvalue         1    526ms  0.37%   526ms   38.5MiB  0.13%  38.5MiB
   affine_kron_atom         1    263ms  0.18%   263ms   20.0MiB  0.07%  20.0MiB
   affine_dot_atom_...      1    220ms  0.15%   220ms   17.3MiB  0.06%  17.3MiB
   affine_diag_atom         1    191ms  0.13%   191ms   23.5MiB  0.08%  23.5MiB
   affine_negate_atom       1    106ms  0.07%   106ms   4.43MiB  0.02%  4.43MiB
   affine_trace_atom        1   63.5ms  0.04%  63.5ms   3.64MiB  0.01%  3.64MiB
 sdp                        1    25.1s  17.5%   25.1s   2.44GiB  8.55%  2.44GiB
   sdp_operator_nor...      1    3.31s  2.31%   3.31s    269MiB  0.92%   269MiB
   sdp_Partial_trace        1    3.14s  2.19%   3.14s    307MiB  1.05%   307MiB
   sdp_lambda_min_atom      1    2.65s  1.85%   2.65s    243MiB  0.83%   243MiB
   sdp_matrix_frac_...      1    1.81s  1.26%   1.81s    142MiB  0.49%   142MiB
   sdp_Complex_Vari...      1    1.78s  1.25%   1.78s    295MiB  1.01%   295MiB
   sdp_sum_largest_...      1    1.58s  1.11%   1.58s    148MiB  0.50%   148MiB
   sdp_nuclear_norm...      1    1.58s  1.10%   1.58s    143MiB  0.49%   143MiB
   sdp_matrix_frac_...      1    1.33s  0.93%   1.33s    103MiB  0.35%   103MiB
   sdp_dual_lambda_...      1    974ms  0.68%   974ms   86.3MiB  0.30%  86.3MiB
   sdp_socp_sumsqua...      1    776ms  0.54%   776ms   64.4MiB  0.22%  64.4MiB
   sdp_Issue_198            1    644ms  0.45%   644ms   51.9MiB  0.18%  51.9MiB
   sdp_Real_Variabl...      1    455ms  0.32%   455ms   48.8MiB  0.17%  48.8MiB
   sdp_sdp_variables        1    397ms  0.28%   397ms   33.4MiB  0.11%  33.4MiB
   sdp_socp_norm2_atom      1    386ms  0.27%   386ms   25.9MiB  0.09%  25.9MiB
   sdp_socp_abs_atom        1    302ms  0.21%   302ms   18.7MiB  0.06%  18.7MiB
   sdp_sigma_max_atom       1    279ms  0.19%   279ms   19.3MiB  0.07%  19.3MiB
   sdp_kron_atom            1    249ms  0.17%   249ms   27.4MiB  0.09%  27.4MiB
   sdp_sdp_constraints      1    184ms  0.13%   184ms   13.9MiB  0.05%  13.9MiB
 lp                         1    17.1s  12.0%   17.1s   9.38GiB  32.9%  9.38GiB
   lp_minimum_atom          1    8.84s  6.18%   8.84s   6.46GiB  22.6%  6.46GiB
   lp_sumsmallest_atom      1    2.45s  1.71%   2.45s   1.80GiB  6.31%  1.80GiB
   lp_sumlargest_atom       1    1.36s  0.95%   1.36s    583MiB  1.99%   583MiB
   lp_dotsort_atom          1    1.32s  0.92%   1.32s    187MiB  0.64%   187MiB
   lp_neg_atom              1    493ms  0.34%   493ms   32.8MiB  0.11%  32.8MiB
   lp_dual_abs_atom         1    389ms  0.27%   389ms   33.1MiB  0.11%  33.1MiB
   lp_maximum_atom          1    318ms  0.22%   318ms   47.4MiB  0.16%  47.4MiB
   lp_dual_norm_inf...      1    157ms  0.11%   157ms   9.77MiB  0.03%  9.77MiB
   lp_pos_atom              1    117ms  0.08%   117ms   9.78MiB  0.03%  9.78MiB
   lp_dual_norm_1_atom      1    106ms  0.07%   106ms   7.08MiB  0.02%  7.08MiB
   lp_hinge_loss_atom       1    358μs  0.00%   358μs   49.7KiB  0.00%  49.7KiB
 constant                   1    13.0s  9.08%   13.0s   1.25GiB  4.37%  1.25GiB
   constant_fix!_wi...      1    4.35s  3.04%   4.35s    409MiB  1.40%   409MiB
   constant_Issue_166       1    3.33s  2.33%   3.33s    350MiB  1.20%   350MiB
   constant_fix!_wi...      1    2.24s  1.57%   2.24s    166MiB  0.57%   166MiB
   constant_Issue_228       1    884ms  0.62%   884ms   68.1MiB  0.23%  68.1MiB
   constant_Test_do...      1    514ms  0.36%   514ms   28.7MiB  0.10%  28.7MiB
   constant_fix!_an...      1    336ms  0.23%   336ms   32.0MiB  0.11%  32.0MiB
 ──────────────────────────────────────────────────────────────────────────────
```

## SDPA_GMP presolve=false
These tests were run on March 3, 2020 at 16:31 (UTC).
...
Tests took 1 minute, 16 seconds, 137 milliseconds to run (after warmup).
...
```julia
 ──────────────────────────────────────────────────────────────────────────────
                                       Time                   Allocations      
                               ──────────────────────   ───────────────────────
       Tot / % measured:            77.1s / 98.7%           6.72GiB / 98.9%    

 Section               ncalls     time   %tot     avg     alloc   %tot      avg
 ──────────────────────────────────────────────────────────────────────────────
 socp                       1    35.8s  47.0%   35.8s    819MiB  12.0%   819MiB
   socp_dual_froben...      1    25.4s  33.4%   25.4s   25.0MiB  0.37%  25.0MiB
   socp_dual_minima...      1    3.69s  4.85%   3.69s    310MiB  4.54%   310MiB
   socp_rational_no...      1    1.29s  1.70%   1.29s   45.4MiB  0.67%  45.4MiB
   socp_dual_norm_2...      1    703ms  0.92%   703ms   56.5MiB  0.83%  56.5MiB
   socp_fix_multipl...      1    544ms  0.72%   544ms   34.7MiB  0.51%  34.7MiB
   socp_inv_pos_atom        1    436ms  0.57%   436ms   15.4MiB  0.23%  15.4MiB
   socp_rational_no...      1    422ms  0.55%   422ms   11.6MiB  0.17%  11.6MiB
   socp_square_atom         1    352ms  0.46%   352ms   17.3MiB  0.25%  17.3MiB
   socp_rational_no...      1    288ms  0.38%   288ms   12.8MiB  0.19%  12.8MiB
   socp_quad_form_atom      1    240ms  0.32%   240ms   13.0MiB  0.19%  13.0MiB
   socp_huber_atom          1    174ms  0.23%   174ms   14.1MiB  0.21%  14.1MiB
   socp_quad_over_l...      1    162ms  0.21%   162ms   9.00MiB  0.13%  9.00MiB
   socp_sum_squares...      1    138ms  0.18%   138ms   8.74MiB  0.13%  8.74MiB
   socp_geo_mean_atom       1    135ms  0.18%   135ms   5.55MiB  0.08%  5.55MiB
   socp_fix_and_fre...      1   92.6ms  0.12%  92.6ms   4.39MiB  0.06%  4.39MiB
   socp_norm_consis...      1    444μs  0.00%   444μs   58.9KiB  0.00%  58.9KiB
   socp_sqrt_atom           1   95.5μs  0.00%  95.5μs   22.2KiB  0.00%  22.2KiB
 affine                     1    18.0s  23.6%   18.0s   4.66GiB  70.1%  4.66GiB
   affine_Partial_t...      1    11.1s  14.6%   11.1s   4.14GiB  62.2%  4.14GiB
   affine_transpose...      1    587ms  0.77%   587ms   22.9MiB  0.34%  22.9MiB
   affine_dot_multi...      1    453ms  0.60%   453ms   31.3MiB  0.46%  31.3MiB
   affine_multiply_...      1    410ms  0.54%   410ms   28.1MiB  0.41%  28.1MiB
   affine_index_atom        1    409ms  0.54%   409ms   29.3MiB  0.43%  29.3MiB
   affine_hcat_atom         1    393ms  0.52%   393ms   9.51MiB  0.14%  9.51MiB
   affine_reshape_atom      1    387ms  0.51%   387ms   18.4MiB  0.27%  18.4MiB
   affine_vcat_atom         1    333ms  0.44%   333ms   12.1MiB  0.18%  12.1MiB
   affine_sum_atom          1    320ms  0.42%   320ms   23.1MiB  0.34%  23.1MiB
   affine_Diagonal_...      1    227ms  0.30%   227ms   20.4MiB  0.30%  20.4MiB
   affine_dualvalue         1    184ms  0.24%   184ms   13.2MiB  0.19%  13.2MiB
   affine_add_atom          1    180ms  0.24%   180ms   10.1MiB  0.15%  10.1MiB
   affine_diag_atom         1    165ms  0.22%   165ms   16.1MiB  0.24%  16.1MiB
   affine_conv_atom         1    159ms  0.21%   159ms   9.82MiB  0.14%  9.82MiB
   affine_satisfy_p...      1    119ms  0.16%   119ms   6.36MiB  0.09%  6.36MiB
   affine_dot_atom          1   79.8ms  0.10%  79.8ms   6.50MiB  0.10%  6.50MiB
   affine_permutedd...      1   73.5ms  0.10%  73.5ms   1.60MiB  0.02%  1.60MiB
   affine_dot_atom_...      1   65.5ms  0.09%  65.5ms   3.69MiB  0.05%  3.69MiB
   affine_trace_atom        1   61.0ms  0.08%  61.0ms   3.34MiB  0.05%  3.34MiB
   affine_negate_atom       1   59.6ms  0.08%  59.6ms   2.94MiB  0.04%  2.94MiB
   affine_kron_atom         1    250μs  0.00%   250μs   30.2KiB  0.00%  30.2KiB
 lp                         1    14.4s  19.0%   14.4s    538MiB  7.89%   538MiB
   lp_min_atom              1    3.67s  4.82%   3.67s   98.5MiB  1.45%  98.5MiB
   lp_minimum_atom          1    3.60s  4.73%   3.60s   29.2MiB  0.43%  29.2MiB
   lp_max_atom              1    3.55s  4.66%   3.55s   94.6MiB  1.39%  94.6MiB
   lp_sumsmallest_atom      1    701ms  0.92%   701ms   26.4MiB  0.39%  26.4MiB
   lp_sumlargest_atom       1    564ms  0.74%   564ms   36.2MiB  0.53%  36.2MiB
   lp_dotsort_atom          1    386ms  0.51%   386ms   24.1MiB  0.35%  24.1MiB
   lp_dual_abs_atom         1    263ms  0.35%   263ms   18.1MiB  0.27%  18.1MiB
   lp_maximum_atom          1    134ms  0.18%   134ms   13.4MiB  0.20%  13.4MiB
   lp_pos_atom              1    117ms  0.15%   117ms   7.27MiB  0.11%  7.27MiB
   lp_dual_norm_inf...      1    107ms  0.14%   107ms   4.71MiB  0.07%  4.71MiB
   lp_dual_norm_1_atom      1   99.0ms  0.13%  99.0ms   4.57MiB  0.07%  4.57MiB
   lp_neg_atom              1   79.3ms  0.10%  79.3ms   5.24MiB  0.08%  5.24MiB
   lp_hinge_loss_atom       1   80.6μs  0.00%  80.6μs   21.4KiB  0.00%  21.4KiB
 sdp                        1    6.19s  8.14%   6.19s    526MiB  7.73%   526MiB
   sdp_matrix_frac_...      1    854ms  1.12%   854ms   61.1MiB  0.90%  61.1MiB
   sdp_Complex_Vari...      1    638ms  0.84%   638ms   16.6MiB  0.24%  16.6MiB
   sdp_sum_largest_...      1    376ms  0.49%   376ms   31.7MiB  0.46%  31.7MiB
   sdp_sdp_variables        1    362ms  0.48%   362ms   27.5MiB  0.40%  27.5MiB
   sdp_Real_Variabl...      1    357ms  0.47%   357ms   9.29MiB  0.14%  9.29MiB
   sdp_Partial_trace        1    333ms  0.44%   333ms   29.4MiB  0.43%  29.4MiB
   sdp_Issue_198            1    259ms  0.34%   259ms   20.3MiB  0.30%  20.3MiB
   sdp_dual_lambda_...      1    253ms  0.33%   253ms   27.8MiB  0.41%  27.8MiB
   sdp_socp_sumsqua...      1    244ms  0.32%   244ms   10.4MiB  0.15%  10.4MiB
   sdp_nuclear_norm...      1    143ms  0.19%   143ms   20.6MiB  0.30%  20.6MiB
   sdp_sigma_max_atom       1    128ms  0.17%   128ms   15.2MiB  0.22%  15.2MiB
   sdp_matrix_frac_...      1    128ms  0.17%   128ms   10.4MiB  0.15%  10.4MiB
   sdp_operator_nor...      1    124ms  0.16%   124ms   14.9MiB  0.22%  14.9MiB
   sdp_sdp_constraints      1    109ms  0.14%   109ms   9.73MiB  0.14%  9.73MiB
   sdp_socp_abs_atom        1    106ms  0.14%   106ms   5.13MiB  0.08%  5.13MiB
   sdp_socp_norm2_atom      1   97.9ms  0.13%  97.9ms   4.73MiB  0.07%  4.73MiB
   sdp_kron_atom            1   93.9ms  0.12%  93.9ms   7.16MiB  0.11%  7.16MiB
   sdp_lambda_min_atom      1   64.9ms  0.09%  64.9ms   5.03MiB  0.07%  5.03MiB
 constant                   1    1.69s  2.23%   1.69s    156MiB  2.28%   156MiB
   constant_Issue_166       1    548ms  0.72%   548ms   68.1MiB  1.00%  68.1MiB
   constant_fix!_wi...      1    235ms  0.31%   235ms   10.9MiB  0.16%  10.9MiB
   constant_fix!_wi...      1    174ms  0.23%   174ms   10.0MiB  0.15%  10.0MiB
   constant_Test_do...      1    117ms  0.15%   117ms   6.00MiB  0.09%  6.00MiB
   constant_Issue_228       1    110ms  0.14%   110ms   9.89MiB  0.15%  9.89MiB
   constant_fix!_an...      1   64.9ms  0.09%  64.9ms   3.75MiB  0.06%  3.75MiB
 ──────────────────────────────────────────────────────────────────────────────
```
