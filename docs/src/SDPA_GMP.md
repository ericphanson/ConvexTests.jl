...
Compilation warmup estimates 30 seconds in compilation time.

## SDPA_GMP presolve=true
These tests were run on March 3, 2020 at 12:38 (UTC).

Tests with SDPA-GMP via SDPAFamily.jl. The problems `lp_max_atom` and `lp_min_atom` are excluded due to excessive presolve time (~1000 seconds each).
...
Tests took 23 minutes, 45 seconds to run (after warmup).
...
```julia
 ──────────────────────────────────────────────────────────────────────────────
                                       Time                   Allocations      
                               ──────────────────────   ───────────────────────
       Tot / % measured:            1425s / 100%            1718GiB / 100%     

 Section               ncalls     time   %tot     avg     alloc   %tot      avg
 ──────────────────────────────────────────────────────────────────────────────
 affine                     1    1313s  92.2%   1313s   1693GiB  98.5%  1693GiB
   affine_Partial_t...      1    1286s  90.3%   1286s   1689GiB  98.3%  1689GiB
   affine_permutedd...      1    2.65s  0.19%   2.65s    338MiB  0.02%   338MiB
   affine_hcat_atom         1    2.52s  0.18%   2.52s    355MiB  0.02%   355MiB
   affine_dot_multi...      1    2.52s  0.18%   2.52s    216MiB  0.01%   216MiB
   affine_transpose...      1    2.04s  0.14%   2.04s    151MiB  0.01%   151MiB
   affine_multiply_...      1    2.04s  0.14%   2.04s    224MiB  0.01%   224MiB
   affine_vcat_atom         1    1.61s  0.11%   1.61s    224MiB  0.01%   224MiB
   affine_index_atom        1    1.18s  0.08%   1.18s    176MiB  0.01%   176MiB
   affine_satisfy_p...      1    1.12s  0.08%   1.12s   61.9MiB  0.00%  61.9MiB
   affine_Diagonal_...      1    1.11s  0.08%   1.11s    113MiB  0.01%   113MiB
   affine_add_atom          1    1.03s  0.07%   1.03s   69.5MiB  0.00%  69.5MiB
   affine_conv_atom         1    876ms  0.06%   876ms   57.4MiB  0.00%  57.4MiB
   affine_reshape_atom      1    596ms  0.04%   596ms   43.8MiB  0.00%  43.8MiB
   affine_sum_atom          1    569ms  0.04%   569ms   58.7MiB  0.00%  58.7MiB
   affine_dot_atom          1    565ms  0.04%   565ms   27.6MiB  0.00%  27.6MiB
   affine_dualvalue         1    480ms  0.03%   480ms   37.9MiB  0.00%  37.9MiB
   affine_kron_atom         1    292ms  0.02%   292ms   20.0MiB  0.00%  20.0MiB
   affine_dot_atom_...      1    218ms  0.02%   218ms   17.6MiB  0.00%  17.6MiB
   affine_diag_atom         1    200ms  0.01%   200ms   23.5MiB  0.00%  23.5MiB
   affine_negate_atom       1   99.1ms  0.01%  99.1ms   4.47MiB  0.00%  4.47MiB
   affine_trace_atom        1   59.6ms  0.00%  59.6ms   3.66MiB  0.00%  3.66MiB
 socp                       1    58.3s  4.09%   58.3s   12.4GiB  0.72%  12.4GiB
   socp_dual_froben...      1    26.6s  1.87%   26.6s    166MiB  0.01%   166MiB
   socp_rational_no...      1    9.44s  0.66%   9.44s   9.72GiB  0.57%  9.72GiB
   socp_dual_minima...      1    5.76s  0.40%   5.76s    492MiB  0.03%   492MiB
   socp_quad_form_atom      1    2.60s  0.18%   2.60s   38.6MiB  0.00%  38.6MiB
   socp_sum_squares...      1    1.18s  0.08%   1.18s    116MiB  0.01%   116MiB
   socp_inv_pos_atom        1    1.16s  0.08%   1.16s    101MiB  0.01%   101MiB
   socp_rational_no...      1    1.04s  0.07%   1.04s    149MiB  0.01%   149MiB
   socp_dual_norm_2...      1    928ms  0.07%   928ms   74.7MiB  0.00%  74.7MiB
   socp_fix_multipl...      1    787ms  0.06%   787ms   43.2MiB  0.00%  43.2MiB
   socp_rational_no...      1    688ms  0.05%   688ms    225MiB  0.01%   225MiB
   socp_quad_over_l...      1    679ms  0.05%   679ms   34.1MiB  0.00%  34.1MiB
   socp_square_atom         1    580ms  0.04%   580ms   34.5MiB  0.00%  34.5MiB
   socp_norm_consis...      1    560ms  0.04%   560ms   35.9MiB  0.00%  35.9MiB
   socp_huber_atom          1    549ms  0.04%   549ms   65.4MiB  0.00%  65.4MiB
   socp_geo_mean_atom       1    402ms  0.03%   402ms   30.0MiB  0.00%  30.0MiB
   socp_fix_and_fre...      1    314ms  0.02%   314ms   32.7MiB  0.00%  32.7MiB
   socp_sqrt_atom           1   45.5ms  0.00%  45.5ms   1.10MiB  0.00%  1.10MiB
 sdp                        1    23.6s  1.66%   23.6s   2.37GiB  0.14%  2.37GiB
   sdp_operator_nor...      1    3.14s  0.22%   3.14s    269MiB  0.02%   269MiB
   sdp_Partial_trace        1    2.74s  0.19%   2.74s    273MiB  0.02%   273MiB
   sdp_lambda_min_atom      1    2.60s  0.18%   2.60s    243MiB  0.01%   243MiB
   sdp_matrix_frac_...      1    1.75s  0.12%   1.75s    142MiB  0.01%   142MiB
   sdp_Complex_Vari...      1    1.71s  0.12%   1.71s    292MiB  0.02%   292MiB
   sdp_sum_largest_...      1    1.59s  0.11%   1.59s    148MiB  0.01%   148MiB
   sdp_nuclear_norm...      1    1.48s  0.10%   1.48s    143MiB  0.01%   143MiB
   sdp_matrix_frac_...      1    1.26s  0.09%   1.26s    104MiB  0.01%   104MiB
   sdp_dual_lambda_...      1    929ms  0.07%   929ms   87.9MiB  0.00%  87.9MiB
   sdp_socp_sumsqua...      1    740ms  0.05%   740ms   64.4MiB  0.00%  64.4MiB
   sdp_Real_Variabl...      1    499ms  0.04%   499ms   48.1MiB  0.00%  48.1MiB
   sdp_Issue_198            1    471ms  0.03%   471ms   43.2MiB  0.00%  43.2MiB
   sdp_sdp_variables        1    381ms  0.03%   381ms   33.5MiB  0.00%  33.5MiB
   sdp_socp_norm2_atom      1    358ms  0.03%   358ms   25.9MiB  0.00%  25.9MiB
   sdp_sigma_max_atom       1    298ms  0.02%   298ms   19.6MiB  0.00%  19.6MiB
   sdp_socp_abs_atom        1    267ms  0.02%   267ms   18.2MiB  0.00%  18.2MiB
   sdp_kron_atom            1    229ms  0.02%   229ms   27.4MiB  0.00%  27.4MiB
   sdp_sdp_constraints      1    173ms  0.01%   173ms   13.9MiB  0.00%  13.9MiB
 lp                         1    16.4s  1.15%   16.4s   9.39GiB  0.55%  9.39GiB
   lp_minimum_atom          1    8.55s  0.60%   8.55s   6.46GiB  0.38%  6.46GiB
   lp_sumsmallest_atom      1    2.34s  0.16%   2.34s   1.80GiB  0.10%  1.80GiB
   lp_sumlargest_atom       1    1.33s  0.09%   1.33s    583MiB  0.03%   583MiB
   lp_dotsort_atom          1    1.21s  0.09%   1.21s    187MiB  0.01%   187MiB
   lp_neg_atom              1    431ms  0.03%   431ms   32.8MiB  0.00%  32.8MiB
   lp_dual_abs_atom         1    393ms  0.03%   393ms   33.1MiB  0.00%  33.1MiB
   lp_maximum_atom          1    313ms  0.02%   313ms   47.4MiB  0.00%  47.4MiB
   lp_dual_norm_inf...      1    135ms  0.01%   135ms   9.80MiB  0.00%  9.80MiB
   lp_pos_atom              1    115ms  0.01%   115ms   9.78MiB  0.00%  9.78MiB
   lp_dual_norm_1_atom      1    115ms  0.01%   115ms   7.10MiB  0.00%  7.10MiB
   lp_hinge_loss_atom       1    236μs  0.00%   236μs   49.7KiB  0.00%  49.7KiB
 constant                   1    12.7s  0.89%   12.7s   1.25GiB  0.07%  1.25GiB
   constant_fix!_wi...      1    4.24s  0.30%   4.24s    408MiB  0.02%   408MiB
   constant_Issue_166       1    3.23s  0.23%   3.23s    350MiB  0.02%   350MiB
   constant_fix!_wi...      1    2.18s  0.15%   2.18s    166MiB  0.01%   166MiB
   constant_Issue_228       1    878ms  0.06%   878ms   68.2MiB  0.00%  68.2MiB
   constant_Test_do...      1    476ms  0.03%   476ms   28.7MiB  0.00%  28.7MiB
   constant_fix!_an...      1    369ms  0.03%   369ms   31.9MiB  0.00%  31.9MiB
 ──────────────────────────────────────────────────────────────────────────────
```

## SDPA_GMP presolve=false
These tests were run on March 3, 2020 at 12:39 (UTC).
...
```julia
 ──────────────────────────────────────────────────────────────────────────────
                                       Time                   Allocations      
                               ──────────────────────   ───────────────────────
       Tot / % measured:            75.7s / 98.7%           6.48GiB / 98.9%    

 Section               ncalls     time   %tot     avg     alloc   %tot      avg
 ──────────────────────────────────────────────────────────────────────────────
 socp                       1    36.5s  48.9%   36.5s    819MiB  12.5%   819MiB
   socp_dual_froben...      1    26.3s  35.2%   26.3s   25.0MiB  0.38%  25.0MiB
   socp_dual_minima...      1    3.76s  5.03%   3.76s    310MiB  4.72%   310MiB
   socp_rational_no...      1    1.30s  1.73%   1.30s   45.4MiB  0.69%  45.4MiB
   socp_dual_norm_2...      1    698ms  0.93%   698ms   56.6MiB  0.86%  56.6MiB
   socp_fix_multipl...      1    529ms  0.71%   529ms   34.7MiB  0.53%  34.7MiB
   socp_inv_pos_atom        1    434ms  0.58%   434ms   15.4MiB  0.23%  15.4MiB
   socp_rational_no...      1    419ms  0.56%   419ms   11.6MiB  0.18%  11.6MiB
   socp_square_atom         1    348ms  0.47%   348ms   17.3MiB  0.26%  17.3MiB
   socp_rational_no...      1    294ms  0.39%   294ms   12.8MiB  0.19%  12.8MiB
   socp_quad_form_atom      1    239ms  0.32%   239ms   13.0MiB  0.20%  13.0MiB
   socp_quad_over_l...      1    166ms  0.22%   166ms   8.99MiB  0.14%  8.99MiB
   socp_huber_atom          1    153ms  0.21%   153ms   14.0MiB  0.21%  14.0MiB
   socp_sum_squares...      1    135ms  0.18%   135ms   8.77MiB  0.13%  8.77MiB
   socp_geo_mean_atom       1    134ms  0.18%   134ms   5.58MiB  0.08%  5.58MiB
   socp_fix_and_fre...      1   84.7ms  0.11%  84.7ms   4.46MiB  0.07%  4.46MiB
   socp_norm_consis...      1    380μs  0.00%   380μs   58.9KiB  0.00%  58.9KiB
   socp_sqrt_atom           1   83.9μs  0.00%  83.9μs   22.2KiB  0.00%  22.2KiB
 affine                     1    15.7s  21.0%   15.7s   4.42GiB  68.9%  4.42GiB
   affine_Partial_t...      1    9.53s  12.7%   9.53s   3.91GiB  61.0%  3.91GiB
   affine_transpose...      1    581ms  0.78%   581ms   22.9MiB  0.35%  22.9MiB
   affine_dot_multi...      1    457ms  0.61%   457ms   31.3MiB  0.48%  31.3MiB
   affine_multiply_...      1    398ms  0.53%   398ms   28.2MiB  0.43%  28.2MiB
   affine_hcat_atom         1    396ms  0.53%   396ms   9.50MiB  0.14%  9.50MiB
   affine_index_atom        1    379ms  0.51%   379ms   29.3MiB  0.45%  29.3MiB
   affine_reshape_atom      1    362ms  0.48%   362ms   18.4MiB  0.28%  18.4MiB
   affine_vcat_atom         1    331ms  0.44%   331ms   12.1MiB  0.18%  12.1MiB
   affine_sum_atom          1    296ms  0.40%   296ms   23.1MiB  0.35%  23.1MiB
   affine_Diagonal_...      1    218ms  0.29%   218ms   20.5MiB  0.31%  20.5MiB
   affine_dualvalue         1    173ms  0.23%   173ms   13.3MiB  0.20%  13.3MiB
   affine_add_atom          1    166ms  0.22%   166ms   10.3MiB  0.16%  10.3MiB
   affine_diag_atom         1    162ms  0.22%   162ms   16.1MiB  0.25%  16.1MiB
   affine_conv_atom         1    151ms  0.20%   151ms   9.82MiB  0.15%  9.82MiB
   affine_satisfy_p...      1    121ms  0.16%   121ms   6.30MiB  0.10%  6.30MiB
   affine_dot_atom          1   73.6ms  0.10%  73.6ms   6.52MiB  0.10%  6.52MiB
   affine_dot_atom_...      1   58.3ms  0.08%  58.3ms   3.69MiB  0.06%  3.69MiB
   affine_trace_atom        1   55.9ms  0.07%  55.9ms   3.34MiB  0.05%  3.34MiB
   affine_negate_atom       1   54.8ms  0.07%  54.8ms   2.96MiB  0.05%  2.96MiB
   affine_permutedd...      1   17.0ms  0.02%  17.0ms    425KiB  0.01%   425KiB
   affine_kron_atom         1    225μs  0.00%   225μs   30.2KiB  0.00%  30.2KiB
 lp                         1    14.8s  19.8%   14.8s    538MiB  8.19%   538MiB
   lp_min_atom              1    3.87s  5.18%   3.87s   98.6MiB  1.50%  98.6MiB
   lp_max_atom              1    3.69s  4.93%   3.69s   94.7MiB  1.44%  94.7MiB
   lp_minimum_atom          1    3.68s  4.92%   3.68s   29.2MiB  0.44%  29.2MiB
   lp_sumsmallest_atom      1    731ms  0.98%   731ms   26.4MiB  0.40%  26.4MiB
   lp_sumlargest_atom       1    574ms  0.77%   574ms   36.2MiB  0.55%  36.2MiB
   lp_dotsort_atom          1    376ms  0.50%   376ms   24.1MiB  0.37%  24.1MiB
   lp_dual_abs_atom         1    244ms  0.33%   244ms   18.2MiB  0.28%  18.2MiB
   lp_maximum_atom          1    142ms  0.19%   142ms   13.4MiB  0.20%  13.4MiB
   lp_pos_atom              1    109ms  0.15%   109ms   7.30MiB  0.11%  7.30MiB
   lp_dual_norm_inf...      1    103ms  0.14%   103ms   4.73MiB  0.07%  4.73MiB
   lp_dual_norm_1_atom      1   94.6ms  0.13%  94.6ms   4.59MiB  0.07%  4.59MiB
   lp_neg_atom              1   78.9ms  0.11%  78.9ms   5.26MiB  0.08%  5.26MiB
   lp_hinge_loss_atom       1   55.5μs  0.00%  55.5μs   21.4KiB  0.00%  21.4KiB
 sdp                        1    6.04s  8.08%   6.04s    527MiB  8.02%   527MiB
   sdp_matrix_frac_...      1    802ms  1.07%   802ms   61.1MiB  0.93%  61.1MiB
   sdp_Complex_Vari...      1    652ms  0.87%   652ms   16.5MiB  0.25%  16.5MiB
   sdp_Real_Variabl...      1    399ms  0.53%   399ms   9.23MiB  0.14%  9.23MiB
   sdp_sum_largest_...      1    384ms  0.51%   384ms   31.7MiB  0.48%  31.7MiB
   sdp_sdp_variables        1    349ms  0.47%   349ms   27.5MiB  0.42%  27.5MiB
   sdp_Partial_trace        1    305ms  0.41%   305ms   29.5MiB  0.45%  29.5MiB
   sdp_Issue_198            1    238ms  0.32%   238ms   20.3MiB  0.31%  20.3MiB
   sdp_dual_lambda_...      1    230ms  0.31%   230ms   27.8MiB  0.42%  27.8MiB
   sdp_socp_sumsqua...      1    229ms  0.31%   229ms   10.5MiB  0.16%  10.5MiB
   sdp_nuclear_norm...      1    139ms  0.19%   139ms   20.6MiB  0.31%  20.6MiB
   sdp_sigma_max_atom       1    130ms  0.17%   130ms   15.2MiB  0.23%  15.2MiB
   sdp_matrix_frac_...      1    125ms  0.17%   125ms   10.4MiB  0.16%  10.4MiB
   sdp_operator_nor...      1    114ms  0.15%   114ms   14.9MiB  0.23%  14.9MiB
   sdp_sdp_constraints      1    106ms  0.14%   106ms   9.76MiB  0.15%  9.76MiB
   sdp_kron_atom            1   94.9ms  0.13%  94.9ms   7.19MiB  0.11%  7.19MiB
   sdp_socp_abs_atom        1   87.9ms  0.12%  87.9ms   5.18MiB  0.08%  5.18MiB
   sdp_socp_norm2_atom      1   78.6ms  0.11%  78.6ms   4.70MiB  0.07%  4.70MiB
   sdp_lambda_min_atom      1   60.4ms  0.08%  60.4ms   5.03MiB  0.08%  5.03MiB
 constant                   1    1.66s  2.23%   1.66s    156MiB  2.37%   156MiB
   constant_Issue_166       1    527ms  0.70%   527ms   68.1MiB  1.04%  68.1MiB
   constant_fix!_wi...      1    222ms  0.30%   222ms   10.9MiB  0.17%  10.9MiB
   constant_fix!_wi...      1    173ms  0.23%   173ms   10.0MiB  0.15%  10.0MiB
   constant_Test_do...      1    120ms  0.16%   120ms   6.02MiB  0.09%  6.02MiB
   constant_Issue_228       1    111ms  0.15%   111ms   9.94MiB  0.15%  9.94MiB
   constant_fix!_an...      1   67.4ms  0.09%  67.4ms   3.77MiB  0.06%  3.77MiB
 ──────────────────────────────────────────────────────────────────────────────
```
...
```julia
 ──────────────────────────────────────────────────────────────────────────────
                                       Time                   Allocations      
                               ──────────────────────   ───────────────────────
       Tot / % measured:            9.82s / 100%             840MiB / 100%     

 Section               ncalls     time   %tot     avg     alloc   %tot      avg
 ──────────────────────────────────────────────────────────────────────────────
 sdp                        1    2.52s  25.7%   2.52s    235MiB  28.1%   235MiB
   sdp_nuclear_norm...      1    140ms  1.43%   140ms   16.7MiB  1.99%  16.7MiB
   sdp_sigma_max_atom       1    130ms  1.33%   130ms   12.2MiB  1.45%  12.2MiB
   sdp_operator_nor...      1    111ms  1.13%   111ms   12.1MiB  1.44%  12.1MiB
   sdp_matrix_frac_...      1    102ms  1.04%   102ms   8.03MiB  0.96%  8.03MiB
   sdp_matrix_frac_...      1   94.7ms  0.97%  94.7ms   7.44MiB  0.89%  7.44MiB
   sdp_Complex_Vari...      1   85.6ms  0.87%  85.6ms   3.54MiB  0.42%  3.54MiB
   sdp_dual_lambda_...      1   85.4ms  0.87%  85.4ms   7.57MiB  0.90%  7.57MiB
   sdp_sdp_constraints      1   80.2ms  0.82%  80.2ms   7.88MiB  0.94%  7.88MiB
   sdp_kron_atom            1   71.9ms  0.73%  71.9ms   4.42MiB  0.53%  4.42MiB
   sdp_socp_sumsqua...      1   68.6ms  0.70%  68.6ms   6.18MiB  0.74%  6.18MiB
   sdp_Real_Variabl...      1   67.7ms  0.69%  67.7ms   2.67MiB  0.32%  2.67MiB
   sdp_Partial_trace        1   66.8ms  0.68%  66.8ms   6.06MiB  0.72%  6.06MiB
   sdp_sdp_variables        1   63.5ms  0.65%  63.5ms   3.81MiB  0.45%  3.81MiB
   sdp_Issue_198            1   61.2ms  0.62%  61.2ms   3.62MiB  0.43%  3.62MiB
   sdp_lambda_min_atom      1   56.4ms  0.57%  56.4ms   2.13MiB  0.25%  2.13MiB
   sdp_socp_abs_atom        1   51.9ms  0.53%  51.9ms   2.44MiB  0.29%  2.44MiB
   sdp_socp_norm2_atom      1   49.4ms  0.50%  49.4ms   2.13MiB  0.25%  2.13MiB
   sdp_sum_largest_...      1   44.4ms  0.45%  44.4ms   1.61MiB  0.19%  1.61MiB
 affine                     1    2.32s  23.6%   2.32s    163MiB  19.4%   163MiB
   affine_Partial_t...      1   93.4ms  0.95%  93.4ms   4.80MiB  0.57%  4.80MiB
   affine_Diagonal_...      1   87.1ms  0.89%  87.1ms   6.09MiB  0.73%  6.09MiB
   affine_conv_atom         1   82.8ms  0.84%  82.8ms   4.85MiB  0.58%  4.85MiB
   affine_index_atom        1   82.1ms  0.84%  82.1ms   7.09MiB  0.85%  7.09MiB
   affine_dot_atom          1   81.6ms  0.83%  81.6ms   4.77MiB  0.57%  4.77MiB
   affine_vcat_atom         1   81.6ms  0.83%  81.6ms   5.72MiB  0.68%  5.72MiB
   affine_diag_atom         1   80.3ms  0.82%  80.3ms   10.3MiB  1.23%  10.3MiB
   affine_hcat_atom         1   68.9ms  0.70%  68.9ms   3.23MiB  0.38%  3.23MiB
   affine_dot_multi...      1   66.9ms  0.68%  66.9ms   4.82MiB  0.57%  4.82MiB
   affine_reshape_atom      1   64.2ms  0.65%  64.2ms   3.22MiB  0.38%  3.22MiB
   affine_transpose...      1   61.9ms  0.63%  61.9ms   2.57MiB  0.31%  2.57MiB
   affine_negate_atom       1   59.4ms  0.61%  59.4ms   1.13MiB  0.14%  1.13MiB
   affine_add_atom          1   58.3ms  0.59%  58.3ms   1.78MiB  0.21%  1.78MiB
   affine_sum_atom          1   52.4ms  0.53%  52.4ms   1.87MiB  0.22%  1.87MiB
   affine_dot_atom_...      1   51.0ms  0.52%  51.0ms   1.87MiB  0.22%  1.87MiB
   affine_multiply_...      1   50.7ms  0.52%  50.7ms   1.74MiB  0.21%  1.74MiB
   affine_trace_atom        1   49.0ms  0.50%  49.0ms   1.58MiB  0.19%  1.58MiB
   affine_satisfy_p...      1   42.6ms  0.43%  42.6ms    707KiB  0.08%   707KiB
   affine_dualvalue         1   38.5ms  0.39%  38.5ms    628KiB  0.07%   628KiB
   affine_permutedd...      1   17.0ms  0.17%  17.0ms    425KiB  0.05%   425KiB
   affine_kron_atom         1    208μs  0.00%   208μs   30.2KiB  0.00%  30.2KiB
 socp                       1    2.28s  23.2%   2.28s    225MiB  26.8%   225MiB
   socp_fix_multipl...      1    158ms  1.61%   158ms   28.2MiB  3.37%  28.2MiB
   socp_dual_minima...      1   88.3ms  0.90%  88.3ms   5.61MiB  0.67%  5.61MiB
   socp_quad_over_l...      1   83.8ms  0.85%  83.8ms   6.16MiB  0.73%  6.16MiB
   socp_geo_mean_atom       1   82.1ms  0.84%  82.1ms   3.00MiB  0.36%  3.00MiB
   socp_square_atom         1   81.7ms  0.83%  81.7ms   6.63MiB  0.79%  6.63MiB
   socp_rational_no...      1   81.2ms  0.83%  81.2ms   6.51MiB  0.78%  6.51MiB
   socp_dual_norm_2...      1   79.8ms  0.81%  79.8ms   6.52MiB  0.78%  6.52MiB
   socp_sum_squares...      1   79.4ms  0.81%  79.4ms   6.34MiB  0.76%  6.34MiB
   socp_huber_atom          1   78.6ms  0.80%  78.6ms   10.4MiB  1.24%  10.4MiB
   socp_dual_froben...      1   78.5ms  0.80%  78.5ms   6.72MiB  0.80%  6.72MiB
   socp_rational_no...      1   71.7ms  0.73%  71.7ms   4.82MiB  0.57%  4.82MiB
   socp_rational_no...      1   71.4ms  0.73%  71.4ms   5.30MiB  0.63%  5.30MiB
   socp_inv_pos_atom        1   70.8ms  0.72%  70.8ms   2.18MiB  0.26%  2.18MiB
   socp_quad_form_atom      1   65.3ms  0.67%  65.3ms   3.58MiB  0.43%  3.58MiB
   socp_fix_and_fre...      1   41.7ms  0.43%  41.7ms    638KiB  0.07%   638KiB
   socp_norm_consis...      1    368μs  0.00%   368μs   58.9KiB  0.01%  58.9KiB
   socp_sqrt_atom           1   64.7μs  0.00%  64.7μs   22.2KiB  0.00%  22.2KiB
 lp                         1    1.36s  13.8%   1.36s    136MiB  16.2%   136MiB
   lp_dotsort_atom          1    117ms  1.19%   117ms   10.5MiB  1.25%  10.5MiB
   lp_minimum_atom          1    113ms  1.15%   113ms   11.3MiB  1.35%  11.3MiB
   lp_sumlargest_atom       1   80.0ms  0.81%  80.0ms   10.6MiB  1.27%  10.6MiB
   lp_maximum_atom          1   76.9ms  0.78%  76.9ms   10.7MiB  1.28%  10.7MiB
   lp_pos_atom              1   72.3ms  0.74%  72.3ms   4.78MiB  0.57%  4.78MiB
   lp_sumsmallest_atom      1   67.4ms  0.69%  67.4ms   8.00MiB  0.95%  8.00MiB
   lp_neg_atom              1   61.9ms  0.63%  61.9ms   2.85MiB  0.34%  2.85MiB
   lp_dual_norm_inf...      1   55.3ms  0.56%  55.3ms   1.70MiB  0.20%  1.70MiB
   lp_dual_norm_1_atom      1   54.7ms  0.56%  54.7ms   1.70MiB  0.20%  1.70MiB
   lp_dual_abs_atom         1   49.8ms  0.51%  49.8ms   1.22MiB  0.15%  1.22MiB
   lp_hinge_loss_atom       1   77.0μs  0.00%  77.0μs   21.4KiB  0.00%  21.4KiB
 constant                   1    1.33s  13.6%   1.33s   79.2MiB  9.45%  79.2MiB
   constant_Issue_166       1    629ms  6.41%   629ms   33.5MiB  4.00%  33.5MiB
   constant_Issue_228       1   80.6ms  0.82%  80.6ms   7.03MiB  0.84%  7.03MiB
   constant_fix!_wi...      1   77.2ms  0.79%  77.2ms   2.97MiB  0.35%  2.97MiB
   constant_fix!_wi...      1   77.1ms  0.79%  77.1ms   3.33MiB  0.40%  3.33MiB
   constant_Test_do...      1   64.1ms  0.65%  64.1ms   1.65MiB  0.20%  1.65MiB
   constant_fix!_an...      1   59.0ms  0.60%  59.0ms   1.98MiB  0.24%  1.98MiB
 ──────────────────────────────────────────────────────────────────────────────
```
...
```julia
  ...
  [4ec0a83e] Unicode 
```
## SDPA_GMP presolve=false (dualized)
These tests were run on March 3, 2020 at 12:39 (UTC).
...
Error During Test at /home/runner/work/ConvexTests.jl/ConvexTests.jl/src/ConvexTests.jl:31
  ...
  Stacktrace:
   ...
   [22] #do_tests#5(::String, ::Bool, ::Bool, ::String, ::Type, ::Array{Regex,1}, ::Base.Iterators.Pairs{Union{},Union{},Tuple{},NamedTuple{(),Tuple{}}}, ::typeof(do_tests), ::String, ::var"#8#9"{Base.Iterators.Pairs{Symbol,Bool,Tuple{Symbol,Symbol},NamedTuple{(:presolve, :silent),Tuple{Bool,Bool}}}}) at /home/runner/work/ConvexTests.jl/ConvexTests.jl/src/ConvexTests.jl:53
   [23] (::ConvexTests.var"#kw##do_tests")(::NamedTuple{(:exclude, :variant, :T, :description, :first, :last),Tuple{Array{Regex,1},String,DataType,String,Bool,Bool}}, ::typeof(do_tests), ::String, ::Function) at ./none:0
   [24] top-level scope at /home/runner/work/ConvexTests.jl/ConvexTests.jl/SDPA_GMP/test.jl:28
   [25] include at ./boot.jl:328 [inlined]
   [26] include_relative(::Module, ::String) at ./loading.jl:1105
   [27] include(::Module, ::String) at ./Base.jl:31
   [28] exec_options(::Base.JLOptions) at ./client.jl:287
...
Error During Test at /home/runner/work/ConvexTests.jl/ConvexTests.jl/src/ConvexTests.jl:31
  ...
  Stacktrace:
   ...
   [6] solve!(::Convex.Problem{BigFloat}, ::Function) at /home/runner/.julia/packages/Convex/IJj5u/src/solution.jl:192
   [7] (::ConvexTests.var"#6#9"{var"#8#9"{Base.Iterators.Pairs{Symbol,Bool,Tuple{Symbol,Symbol},NamedTuple{(:presolve, :silent),Tuple{Bool,Bool}}}}})(::Convex.Problem{BigFloat}) at /home/runner/work/ConvexTests.jl/ConvexTests.jl/src/ConvexTests.jl:56
   [8] lp_min_atom(::ConvexTests.var"#6#9"{var"#8#9"{Base.Iterators.Pairs{Symbol,Bool,Tuple{Symbol,Symbol},NamedTuple{(:presolve, :silent),Tuple{Bool,Bool}}}}}, ::Val{true}, ::Float64, ::Float64, ::Type{BigFloat}) at /home/runner/.julia/packages/Convex/IJj5u/src/problem_depot/problems/lp.jl:110
   [9] macro expansion at /home/runner/work/ConvexTests.jl/ConvexTests.jl/src/ConvexTests.jl:32 [inlined] (repeats 2 times)
   [10] macro expansion at /home/runner/.julia/packages/TimerOutputs/7Id5J/src/TimerOutput.jl:214 [inlined]
...
Error During Test at /home/runner/work/ConvexTests.jl/ConvexTests.jl/src/ConvexTests.jl:31
  ...
  Stacktrace:
   ...
   [6] solve!(::Convex.Problem{BigFloat}, ::Function) at /home/runner/.julia/packages/Convex/IJj5u/src/solution.jl:192
   [7] (::ConvexTests.var"#6#9"{var"#8#9"{Base.Iterators.Pairs{Symbol,Bool,Tuple{Symbol,Symbol},NamedTuple{(:presolve, :silent),Tuple{Bool,Bool}}}}})(::Convex.Problem{BigFloat}) at /home/runner/work/ConvexTests.jl/ConvexTests.jl/src/ConvexTests.jl:56
   [8] lp_max_atom(::ConvexTests.var"#6#9"{var"#8#9"{Base.Iterators.Pairs{Symbol,Bool,Tuple{Symbol,Symbol},NamedTuple{(:presolve, :silent),Tuple{Bool,Bool}}}}}, ::Val{true}, ::Float64, ::Float64, ::Type{BigFloat}) at /home/runner/.julia/packages/Convex/IJj5u/src/problem_depot/problems/lp.jl:91
   [9] macro expansion at /home/runner/work/ConvexTests.jl/ConvexTests.jl/src/ConvexTests.jl:32 [inlined] (repeats 2 times)
   [10] macro expansion at /home/runner/.julia/packages/TimerOutputs/7Id5J/src/TimerOutput.jl:214 [inlined]
...
```julia
 ──────────────────────────────────────────────────────────────────────────────
                                       Time                   Allocations      
                               ──────────────────────   ───────────────────────
       Tot / % measured:            2.53s / 100%            71.3MiB / 97.3%    

 Section               ncalls     time   %tot     avg     alloc   %tot      avg
 ──────────────────────────────────────────────────────────────────────────────
 lp                         1    714ms  28.2%   714ms   52.3MiB  75.4%  52.3MiB
   lp_min_atom              1    120ms  4.75%   120ms   12.0MiB  17.3%  12.0MiB
   lp_max_atom              1    117ms  4.63%   117ms   12.0MiB  17.2%  12.0MiB
   lp_dual_norm_inf...      1   33.4ms  1.32%  33.4ms    282KiB  0.40%   282KiB
   lp_dotsort_atom          1   31.2ms  1.24%  31.2ms    292KiB  0.41%   292KiB
   lp_sumsmallest_atom      1   30.5ms  1.21%  30.5ms    283KiB  0.40%   283KiB
   lp_dual_abs_atom         1   30.4ms  1.20%  30.4ms    282KiB  0.40%   282KiB
   lp_minimum_atom          1   30.1ms  1.19%  30.1ms    286KiB  0.40%   286KiB
   lp_sumlargest_atom       1   30.1ms  1.19%  30.1ms    283KiB  0.40%   283KiB
   lp_maximum_atom          1   30.1ms  1.19%  30.1ms    283KiB  0.40%   283KiB
   lp_neg_atom              1   30.1ms  1.19%  30.1ms    283KiB  0.40%   283KiB
   lp_dual_norm_1_atom      1   29.9ms  1.18%  29.9ms    283KiB  0.40%   283KiB
   lp_pos_atom              1   29.9ms  1.18%  29.9ms    283KiB  0.40%   283KiB
   lp_hinge_loss_atom       1   35.4μs  0.00%  35.4μs   21.4KiB  0.03%  21.4KiB
 affine                     1    611ms  24.2%   611ms   5.87MiB  8.46%  5.87MiB
   affine_Diagonal_...      1   35.2ms  1.39%  35.2ms    283KiB  0.40%   283KiB
   affine_Partial_t...      1   34.3ms  1.36%  34.3ms    331KiB  0.47%   331KiB
   affine_dot_atom          1   34.0ms  1.34%  34.0ms    283KiB  0.40%   283KiB
   affine_dot_multi...      1   33.4ms  1.32%  33.4ms    283KiB  0.40%   283KiB
   affine_sum_atom          1   33.1ms  1.31%  33.1ms    282KiB  0.40%   282KiB
   affine_reshape_atom      1   31.5ms  1.25%  31.5ms    283KiB  0.40%   283KiB
   affine_multiply_...      1   30.5ms  1.21%  30.5ms    282KiB  0.40%   282KiB
   affine_satisfy_p...      1   30.5ms  1.21%  30.5ms    283KiB  0.40%   283KiB
   affine_hcat_atom         1   30.5ms  1.21%  30.5ms    284KiB  0.40%   284KiB
   affine_trace_atom        1   30.4ms  1.20%  30.4ms    282KiB  0.40%   282KiB
   affine_conv_atom         1   30.4ms  1.20%  30.4ms    287KiB  0.40%   287KiB
   affine_transpose...      1   30.2ms  1.19%  30.2ms    282KiB  0.40%   282KiB
   affine_vcat_atom         1   30.2ms  1.19%  30.2ms    286KiB  0.40%   286KiB
   affine_index_atom        1   30.0ms  1.19%  30.0ms    283KiB  0.40%   283KiB
   affine_negate_atom       1   30.0ms  1.19%  30.0ms    283KiB  0.40%   283KiB
   affine_diag_atom         1   30.0ms  1.19%  30.0ms    282KiB  0.40%   282KiB
   affine_dualvalue         1   29.9ms  1.18%  29.9ms    282KiB  0.40%   282KiB
   affine_add_atom          1   29.9ms  1.18%  29.9ms    283KiB  0.40%   283KiB
   affine_dot_atom_...      1   29.8ms  1.18%  29.8ms    283KiB  0.40%   283KiB
   affine_permutedd...      1   17.1ms  0.68%  17.1ms    425KiB  0.60%   425KiB
   affine_kron_atom         1    176μs  0.01%   176μs   30.2KiB  0.04%  30.2KiB
 sdp                        1    556ms  22.0%   556ms   5.11MiB  7.36%  5.11MiB
   sdp_socp_norm2_atom      1   33.6ms  1.33%  33.6ms    283KiB  0.40%   283KiB
   sdp_sigma_max_atom       1   32.4ms  1.28%  32.4ms    283KiB  0.40%   283KiB
   sdp_lambda_min_atom      1   32.2ms  1.27%  32.2ms    282KiB  0.40%   282KiB
   sdp_Partial_trace        1   32.0ms  1.27%  32.0ms    291KiB  0.41%   291KiB
   sdp_sdp_constraints      1   31.9ms  1.26%  31.9ms    283KiB  0.40%   283KiB
   sdp_sum_largest_...      1   30.8ms  1.22%  30.8ms    282KiB  0.40%   282KiB
   sdp_sdp_variables        1   30.7ms  1.22%  30.7ms    282KiB  0.40%   282KiB
   sdp_operator_nor...      1   30.6ms  1.21%  30.6ms    283KiB  0.40%   283KiB
   sdp_Real_Variabl...      1   30.6ms  1.21%  30.6ms    286KiB  0.40%   286KiB
   sdp_socp_sumsqua...      1   30.5ms  1.21%  30.5ms    283KiB  0.40%   283KiB
   sdp_Complex_Vari...      1   30.5ms  1.21%  30.5ms    287KiB  0.40%   287KiB
   sdp_socp_abs_atom        1   30.2ms  1.20%  30.2ms    282KiB  0.40%   282KiB
   sdp_kron_atom            1   30.2ms  1.20%  30.2ms    291KiB  0.41%   291KiB
   sdp_nuclear_norm...      1   30.1ms  1.19%  30.1ms    283KiB  0.40%   283KiB
   sdp_matrix_frac_...      1   30.0ms  1.19%  30.0ms    283KiB  0.40%   283KiB
   sdp_dual_lambda_...      1   29.9ms  1.18%  29.9ms    283KiB  0.40%   283KiB
   sdp_matrix_frac_...      1   29.9ms  1.18%  29.9ms    283KiB  0.40%   283KiB
   sdp_Issue_198            1   29.8ms  1.18%  29.8ms    282KiB  0.40%   282KiB
 socp                       1    460ms  18.2%   460ms   4.38MiB  6.31%  4.38MiB
   socp_geo_mean_atom       1   37.1ms  1.47%  37.1ms    318KiB  0.45%   318KiB
   socp_dual_froben...      1   30.9ms  1.22%  30.9ms    283KiB  0.40%   283KiB
   socp_square_atom         1   30.6ms  1.21%  30.6ms    283KiB  0.40%   283KiB
   socp_fix_and_fre...      1   30.4ms  1.20%  30.4ms    283KiB  0.40%   283KiB
   socp_rational_no...      1   30.3ms  1.20%  30.3ms    283KiB  0.40%   283KiB
   socp_sum_squares...      1   30.3ms  1.20%  30.3ms    283KiB  0.40%   283KiB
   socp_rational_no...      1   30.0ms  1.19%  30.0ms    284KiB  0.40%   284KiB
   socp_fix_multipl...      1   30.0ms  1.19%  30.0ms    283KiB  0.40%   283KiB
   socp_quad_form_atom      1   30.0ms  1.19%  30.0ms    293KiB  0.41%   293KiB
   socp_dual_minima...      1   30.0ms  1.19%  30.0ms    283KiB  0.40%   283KiB
   socp_dual_norm_2...      1   29.9ms  1.18%  29.9ms    283KiB  0.40%   283KiB
   socp_inv_pos_atom        1   29.9ms  1.18%  29.9ms    283KiB  0.40%   283KiB
   socp_quad_over_l...      1   29.9ms  1.18%  29.9ms    284KiB  0.40%   284KiB
   socp_huber_atom          1   29.9ms  1.18%  29.9ms    282KiB  0.40%   282KiB
   socp_rational_no...      1   29.8ms  1.18%  29.8ms    283KiB  0.40%   283KiB
   socp_norm_consis...      1    333μs  0.01%   333μs   58.9KiB  0.08%  58.9KiB
   socp_sqrt_atom           1   42.8μs  0.00%  42.8μs   22.2KiB  0.03%  22.2KiB
 constant                   1    186ms  7.38%   186ms   1.71MiB  2.46%  1.71MiB
   constant_Test_do...      1   34.6ms  1.37%  34.6ms    282KiB  0.40%   282KiB
   constant_Issue_166       1   30.8ms  1.22%  30.8ms    283KiB  0.40%   283KiB
   constant_fix!_wi...      1   30.8ms  1.22%  30.8ms    283KiB  0.40%   283KiB
   constant_fix!_wi...      1   30.1ms  1.19%  30.1ms    283KiB  0.40%   283KiB
   constant_Issue_228       1   30.0ms  1.19%  30.0ms    283KiB  0.40%   283KiB
   constant_fix!_an...      1   30.0ms  1.19%  30.0ms    282KiB  0.40%   282KiB
 ──────────────────────────────────────────────────────────────────────────────
```
