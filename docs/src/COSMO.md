...
Compilation warmup estimates 21 seconds in compilation time.
...
Test Failed at /home/runner/.julia/packages/Convex/IJj5u/src/problem_depot/problems/lp.jl:95
  Expression: ≈(p.optval, max(max_a, max_b), atol=10atol, atol=atol, rtol=rtol)
   Evaluated: 1.002630877579913 ≈ 1.0 (atol=0.01, atol=0.001, rtol=0.0)
...
```julia
 ──────────────────────────────────────────────────────────────────────────────
                                       Time                   Allocations      
                               ──────────────────────   ───────────────────────
       Tot / % measured:            64.4s / 98.1%           7.82GiB / 98.7%    

 Section               ncalls     time   %tot     avg     alloc   %tot      avg
 ──────────────────────────────────────────────────────────────────────────────
 affine                     1    19.9s  31.5%   19.9s   2.59GiB  33.6%  2.59GiB
   affine_Partial_t...      1    2.07s  3.28%   2.07s    281MiB  3.56%   281MiB
   affine_permutedd...      1    2.01s  3.18%   2.01s    322MiB  4.07%   322MiB
   affine_multiply_...      1    1.59s  2.51%   1.59s    212MiB  2.68%   212MiB
   affine_dot_multi...      1    1.54s  2.43%   1.54s    148MiB  1.87%   148MiB
   affine_transpose...      1    1.40s  2.21%   1.40s    170MiB  2.15%   170MiB
   affine_hcat_atom         1    1.33s  2.11%   1.33s    169MiB  2.13%   169MiB
   affine_Diagonal_...      1    961ms  1.52%   961ms    113MiB  1.43%   113MiB
   affine_vcat_atom         1    912ms  1.44%   912ms   99.5MiB  1.26%  99.5MiB
   affine_add_atom          1    847ms  1.34%   847ms   67.5MiB  0.85%  67.5MiB
   affine_satisfy_p...      1    829ms  1.31%   829ms   57.6MiB  0.73%  57.6MiB
   affine_conv_atom         1    641ms  1.01%   641ms   53.0MiB  0.67%  53.0MiB
   affine_index_atom        1    415ms  0.66%   415ms   40.3MiB  0.51%  40.3MiB
   affine_dot_atom          1    410ms  0.65%   410ms   19.2MiB  0.24%  19.2MiB
   affine_reshape_atom      1    374ms  0.59%   374ms   28.0MiB  0.35%  28.0MiB
   affine_sum_atom          1    269ms  0.43%   269ms   31.2MiB  0.40%  31.2MiB
   affine_kron_atom         1    182ms  0.29%   182ms   19.9MiB  0.25%  19.9MiB
   affine_diag_atom         1    107ms  0.17%   107ms   14.3MiB  0.18%  14.3MiB
   affine_dot_atom_...      1   77.8ms  0.12%  77.8ms   5.02MiB  0.06%  5.02MiB
   affine_negate_atom       1   68.9ms  0.11%  68.9ms   3.89MiB  0.05%  3.89MiB
   affine_trace_atom        1   31.7ms  0.05%  31.7ms   2.68MiB  0.03%  2.68MiB
 sdp                        1    13.0s  20.5%   13.0s   1.34GiB  17.4%  1.34GiB
   sdp_operator_nor...      1    3.50s  5.54%   3.50s    314MiB  3.97%   314MiB
   sdp_Complex_Semi...      1    969ms  1.53%   969ms   26.2MiB  0.33%  26.2MiB
   sdp_matrix_frac_...      1    851ms  1.35%   851ms   81.5MiB  1.03%  81.5MiB
   sdp_matrix_frac_...      1    695ms  1.10%   695ms   68.3MiB  0.86%  68.3MiB
   sdp_Partial_trace        1    629ms  1.00%   629ms   60.2MiB  0.76%  60.2MiB
   sdp_Complex_Vari...      1    614ms  0.97%   614ms   41.0MiB  0.52%  41.0MiB
   sdp_sum_largest_...      1    576ms  0.91%   576ms   46.5MiB  0.59%  46.5MiB
   sdp_socp_sumsqua...      1    487ms  0.77%   487ms   53.6MiB  0.68%  53.6MiB
   sdp_lambda_min_atom      1    436ms  0.69%   436ms   42.3MiB  0.54%  42.3MiB
   sdp_socp_norm2_atom      1    278ms  0.44%   278ms   24.5MiB  0.31%  24.5MiB
   sdp_Issue_198            1    278ms  0.44%   278ms   37.6MiB  0.48%  37.6MiB
   sdp_socp_abs_atom        1    274ms  0.43%   274ms   23.6MiB  0.30%  23.6MiB
   sdp_nuclear_norm...      1    261ms  0.41%   261ms   31.2MiB  0.39%  31.2MiB
   sdp_sdp_variables        1    178ms  0.28%   178ms   23.7MiB  0.30%  23.7MiB
   sdp_sdp_constraints      1    158ms  0.25%   158ms   13.1MiB  0.17%  13.1MiB
   sdp_kron_atom            1    110ms  0.17%   110ms   19.6MiB  0.25%  19.6MiB
   sdp_sigma_max_atom       1    106ms  0.17%   106ms   13.8MiB  0.17%  13.8MiB
   sdp_Real_Variabl...      1   72.8ms  0.12%  72.8ms   5.35MiB  0.07%  5.35MiB
 socp                       1    12.6s  20.0%   12.6s   1.64GiB  21.3%  1.64GiB
   socp_quad_form_atom      1    2.00s  3.17%   2.00s   33.5MiB  0.42%  33.5MiB
   socp_sum_squares...      1    1.93s  3.06%   1.93s    231MiB  2.93%   231MiB
   socp_rational_no...      1    1.89s  2.99%   1.89s    202MiB  2.56%   202MiB
   socp_inv_pos_atom        1    650ms  1.03%   650ms   67.8MiB  0.86%  67.8MiB
   socp_fix_multipl...      1    543ms  0.86%   543ms   46.3MiB  0.59%  46.3MiB
   socp_huber_atom          1    535ms  0.85%   535ms   74.7MiB  0.94%  74.7MiB
   socp_quad_over_l...      1    513ms  0.81%   513ms   30.4MiB  0.38%  30.4MiB
   socp_norm_consis...      1    449ms  0.71%   449ms   33.9MiB  0.43%  33.9MiB
   socp_rational_no...      1    330ms  0.52%   330ms   32.6MiB  0.41%  32.6MiB
   socp_geo_mean_atom       1    254ms  0.40%   254ms   24.4MiB  0.31%  24.4MiB
   socp_fix_and_fre...      1    234ms  0.37%   234ms   30.3MiB  0.38%  30.3MiB
   socp_square_atom         1    218ms  0.34%   218ms   14.7MiB  0.19%  14.7MiB
   socp_sqrt_atom           1   35.0ms  0.06%  35.0ms   1.08MiB  0.01%  1.08MiB
 constant                   1    7.27s  11.5%   7.27s    930MiB  11.8%   930MiB
   constant_fix!_wi...      1    2.50s  3.96%   2.50s    266MiB  3.36%   266MiB
   constant_Issue_166       1    2.36s  3.74%   2.36s    339MiB  4.29%   339MiB
   constant_Issue_228       1    525ms  0.83%   525ms   52.4MiB  0.66%  52.4MiB
   constant_fix!_wi...      1    423ms  0.67%   423ms   44.6MiB  0.56%  44.6MiB
   constant_fix!_an...      1    260ms  0.41%   260ms   22.0MiB  0.28%  22.0MiB
   constant_Test_do...      1    253ms  0.40%   253ms   19.1MiB  0.24%  19.1MiB
 lp                         1    5.83s  9.24%   5.83s    745MiB  9.43%   745MiB
   lp_max_atom              1    1.36s  2.15%   1.36s    187MiB  2.36%   187MiB
   lp_minimum_atom          1    1.03s  1.64%   1.03s   92.6MiB  1.17%  92.6MiB
   lp_dotsort_atom          1    820ms  1.30%   820ms   93.8MiB  1.19%  93.8MiB
   lp_min_atom              1    451ms  0.71%   451ms   39.8MiB  0.50%  39.8MiB
   lp_sumlargest_atom       1    432ms  0.68%   432ms   49.0MiB  0.62%  49.0MiB
   lp_maximum_atom          1    232ms  0.37%   232ms   18.4MiB  0.23%  18.4MiB
   lp_sumsmallest_atom      1    191ms  0.30%   191ms   22.2MiB  0.28%  22.2MiB
   lp_neg_atom              1    160ms  0.25%   160ms   11.6MiB  0.15%  11.6MiB
   lp_pos_atom              1   62.3ms  0.10%  62.3ms   6.34MiB  0.08%  6.34MiB
   lp_hinge_loss_atom       1    178μs  0.00%   178μs   49.7KiB  0.00%  49.7KiB
 exp                        1    2.98s  4.71%   2.98s    338MiB  4.28%   338MiB
   exp_log_atom             1    1.21s  1.92%   1.21s    129MiB  1.63%   129MiB
   exp_entropy_atom         1    367ms  0.58%   367ms   37.4MiB  0.47%  37.4MiB
   exp_log_sum_exp_...      1    212ms  0.34%   212ms   22.2MiB  0.28%  22.2MiB
   exp_exp_atom             1    210ms  0.33%   210ms   18.8MiB  0.24%  18.8MiB
   exp_log_perspect...      1    186ms  0.29%   186ms   20.1MiB  0.25%  20.1MiB
   exp_logistic_los...      1    174ms  0.27%   174ms   14.2MiB  0.18%  14.2MiB
   exp_relative_ent...      1   47.4ms  0.08%  47.4ms   5.33MiB  0.07%  5.33MiB
 sdp_and_exp                1    1.63s  2.58%   1.63s    182MiB  2.31%   182MiB
   sdp_and_exp_log_...      1    1.55s  2.46%   1.55s    167MiB  2.11%   167MiB
 ──────────────────────────────────────────────────────────────────────────────
```
